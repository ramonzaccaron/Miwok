...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("Vó", "ama", R.drawable.family_grandmother, R.raw.family_grandmother));
        words.add(new Word("Vô", "paapa", R.drawable.family_grandfather, R.raw.family_grandfather));
